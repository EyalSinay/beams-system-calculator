...
function RollerSupportsDetails({ details }) {
      ...
      </div>
      {
        editMode
          ...
          <div className='beam-crud-container'>
            <span className='title'>Roller Support</span>
            <label htmlFor='name-roller' className='property'>Name: </label>
            <input id='name-roller' className='beam-input' type="text" placeholder={details.name} value={nameInputValue} onChange={e => setNameInputValue(e.target.value)} />
            <label htmlFor='pos-roller' className='property'>Position: </label>
            <input id='pos-roller' className='beam-input' type="number" placeholder={details.position} value={positionInputValue} onChange={e => setPositionInputValue(e.target.value)} />
          </div>
          :
          <div className='beam-crud-container'>
            <span className='title'>Roller Support</span>
...
export default RollerSupportsDetails;
